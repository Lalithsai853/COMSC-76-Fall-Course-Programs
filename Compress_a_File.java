...
// This program compresses a source file using the Huffman coding method and then sends the binary content to the output file.
...
public class Compress_a_File {
    public static void main(String[] args) throws IOException {
      // Gets two files from the command line 
      File source = new File(args[0]);
      File target = new File(args[1]);
      
      // Creates File Scanner and adds all of the data to a stringbuilder data structure
      ...
      while (reader.hasNext()) {
       ...
       // Frequency of all characters stored into array using getCharacter Frequency Method
       int[] frequency = HuffmanCode.getCharacterFrequency(text.toString());
       
       // Tree created
       HuffmanCode.Tree tree = HuffmanCode.getHuffmanTree(frequency);

       // Codes stored into array 
       String[] codes = HuffmanCode.getCode(tree.root);

       // Codes  for all characters added to a stringbuilder data structure  
       ...
       // Creates new output stream
        ...
        // Writes all of the data to the file (length, bits, and codes)
