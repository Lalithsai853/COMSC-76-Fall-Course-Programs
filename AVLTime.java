// Lalithsai Posam
// AVL Trees Extra Credit Assignment
// This program compares the times an AVL tree and a Binary Search Tree insert, search, and delete 500,000 numbers.
...
public class AVLTime {
    public static void main(String[] args) {
        ...
        BST<Integer> bst_tree = new BST<>();
        AVLTree<Integer> avl_tree = new AVLTree<>();

        // Calculating time for BST
        for (int i = 0; i < 500000; i++) {
            numbers.add((int)(Math.random() * 500000));
        }
        ...
        // Searching for each number
        for (Integer number: numbers) {
            bst_tree.search(number);
        }

        Collections.shuffle(numbers);

        // Deleting each number
        for (Integer number: numbers) {
        ...
        // Displays time for BST
        System.out.println("It takes the Binary Search Tree " + (end_time - start_time) + " milliseconds to complete insertion, a search, and deletion.");

        Collections.shuffle(numbers);

        // Calculating time for AVL tree
        ...
        // Displays time
        System.out.println("It takes the AVL tree " + (end - start) + " milliseconds to complete insertion, a search, and deletion.");
    }
}
